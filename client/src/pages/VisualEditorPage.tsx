...
export default function VisualEditorPage() {
  const { user } = useAuth();
  const { data, isLoading } = trpc.siteContent.list.useQuery(undefined, { enabled: Boolean(user) });
