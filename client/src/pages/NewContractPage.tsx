...
export default function NewContractPage() {
  ...
  const [form, setForm] = useState<ContractForm>(() => ({ customerId: "", vehicleId: preselectedVehicleId, type: "daily", startDate: today, expectedReturnDate: addDays(today, 1), notes: "" }));
  ...
  const submit = () => {
    ...
    create.mutate({ customerId: Number(form.customerId), vehicleId: Number(form.vehicleId), type: form.type, startDate: form.startDate, expectedReturnDate: form.expectedReturnDate, rentalAmount: formatMoney(unitRate), days: amounts.days, totalAmount: amounts.total, paidAmount: "0.00", notes: form.notes.trim() || undefined });
  };
