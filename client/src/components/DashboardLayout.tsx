  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#f5f7fa] text-[#172235]">
      ...
      <main id="main-content" className="min-h-screen overflow-x-hidden lg:mr-[272px]">
        ...
        <div className="min-w-0 p-4 md:p-7">{children}</div>
      </main>
    </div>
  );
}
