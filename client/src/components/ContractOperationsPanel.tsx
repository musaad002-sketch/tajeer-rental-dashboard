...
const options: Array<{ value: Operation; label: string }> = [
  { value: "payment", label: "استلام مبلغ" }, { value: "additional_fee", label: "إضافة رسوم" }, { value: "rate_update", label: "تعديل سعر التأجير" }, { value: "extension", label: "تمديد العقد" }, { value: "vehicle_swap", label: "تبديل السيارة" }, { value: "suspend", label: "تعليق للتعثر" }, { value: "close", label: "إغلاق العقد" }, { value: "return", label: "استرجاع السيارة" },
];
